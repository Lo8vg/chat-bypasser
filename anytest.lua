...
targetLbl.Position = UDim2.new(0, 0, 0, 50)
...
playerList.Size = UDim2.new(1, 0, 0, 90)
playerList.Position = UDim2.new(0, 0, 0, 66)
...
angTog.Position = UDim2.new(0, 0, 0, 48)
...
tpTog.Position = UDim2.new(0.5, 1, 0, 48)
...
massTog.Position = UDim2.new(0, 0, 0, 70)
...
setLbl.Size = UDim2.new(1, 0, 0, 14)
setLbl.Position = UDim2.new(0, 0, 0, 94)
...
velInput.Position = UDim2.new(0, 0, 0, 110)
...
angInput.Position = UDim2.new(0.5, 1, 0, 110)
...
swingInput.Position = UDim2.new(0, 0, 0, 132)
...
reachInput.Position = UDim2.new(0.5, 1, 0, 132)
...
howLbl.Size = UDim2.new(1, 0, 0, 14)
...
info1.Size = UDim2.new(1, 0, 0, 36)
info1.Position = UDim2.new(0, 0, 0, 16)
...
comboLbl.Size = UDim2.new(1, 0, 0, 14)
comboLbl.Position = UDim2.new(0, 0, 0, 56)
...
comboInfo.Size = UDim2.new(1, 0, 0, 40)
comboInfo.Position = UDim2.new(0, 0, 0, 72)
...
killGuiBtn.Size = UDim2.new(1, -8, 0, 30)
killGuiBtn.Position = UDim2.new(0, 4, 0, 22)
...
keyLbl.Position = UDim2.new(0, 0, 0, 134)
...
-- KILL GUI BUTTON (separate danger zone)
...
local function chaosFling(targetRoot, myRoot, myHumanoid)
    ...
    if angularEnabled then
        if bodyAngVal then bodyAngVel:Destroy() end
        bodyAngVel = Instance.new("BodyAngularVelocity")
        bodyAngVel.Name = "CollisionSpin"
        bodyAngVel.MaxTorque = Vector3.new(math.huge, math.huge, math.huge)
...
print("✅ COMBO DESTROYER Loaded - Drag hub icon, click to open")
