-- Combined Hub: Fling + TP Kill + Ultimate Collision (No Logic Changes)
-- Three separate tabs, each works independently
...
tab1Button.Size = UDim2.new(0.333, -3, 1, 0)
...
tab2Button.Size = UDim2.new(0.333, -3, 1, 0)
tab2Button.Position = UDim2.new(0.333, 3, 0, 0)
...
tab3Button.Size = UDim2.new(0.333, -3, 1, 0)
tab3Button.Position = UDim2.new(0.666, 6, 0, 0)
tab3Button.BackgroundColor3 = COLORS.tabInactive
tab3Button.TextColor3 = COLORS.textDark
tab3Button.Text = "Ultimate Fling"
