...
local sendModeRow = Instance.new("Frame")
sendModeRow.Size = UDim2.new(1, -20, 0, 24)
sendModeRow.Position = UDim2.new(0, 10, 0, 10)
sendModeRow.BackgroundTransparency = 1
sendModeRow.Parent = chatSettingsContent

local tapModeBtn = Instance.new("TextButton")
tapModeBtn.Size = UDim2.new(0.5, -2, 1, 0)
tapModeBtn.BackgroundColor3 = Color3.fromRGB(0, 120, 215)
tapModeBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
tapModeBtn.Text = "Tap"
tapModeBtn.Font = Enum.Font.GothamBold
tapModeBtn.TextSize = 10
tapModeBtn.Parent = sendModeRow
local tapModeCorner = Instance.new("UICorner")
tapModeCorner.CornerRadius = UDim.new(0, 6)
tapModeCorner.Parent = tapModeBtn

local autoModeBtn = Instance.new("TextButton")
autoModeBtn.Size = UDim2.new(0.5, -2, 1, 0)
autoModeBtn.Position = UDim2.new(0.5, 2, 0, 0)
autoModeBtn.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
autoModeBtn.TextColor3 = Color3.fromRGB(200, 200, 200)
autoModeBtn.Text = "Auto"
autoModeBtn.Font = Enum.Font.Gotham
autoModeBtn.TextSize = 10
autoModeBtn.Parent = sendModeRow
local autoModeCorner = Instance.new("UICorner")
autoModeCorner.CornerRadius = UDim.new(0, 6)
autoModeCorner.Parent = autoModeBtn

local caseRow = Instance.new("Frame")
caseRow.Size = UDim2.new(1, -20, 0, 24)
caseRow.Position = UDim2.new(0, 10, 0, 38)
...
statusLabel.Position = UDim2.new(0, 10, 0, 66)
statusLabel.BackgroundTransparency = 1
statusLabel.TextColor3 = Color3.fromRGB(150, 150, 150)
statusLabel.Text = "Mode: Upper | Tap"
...
killBtn.Position = UDim2.new(0, 10, 0, 82)
...
print("📌 Send Mode: Tap = click to send each line | Auto = send all with delays")
